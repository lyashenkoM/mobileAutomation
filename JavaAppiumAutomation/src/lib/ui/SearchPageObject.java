...
public class SearchPageObject extends MainPageObject {
    ...
    private static final String //константы
            ...
            SEARCH_RESULT_BY_TITLE_AND_DESCRIPTION = "xpath://android.widget.LinearLayout[android.widget.TextView[@text='{SUBSTRING1}']][android.widget.TextView[@text='{SUBSTRING2}']]";
